...
[`BasetenError`](https://github.com/veerbia/baseten-python/blob/master/./src/baseten/models/basetenerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary error:**
* [`BasetenError`](https://github.com/veerbia/baseten-python/blob/master/./src/baseten/models/basetenerror.py): The base class for HTTP error responses.
...
**Inherit from [`BasetenError`](https://github.com/veerbia/baseten-python/blob/master/./src/baseten/models/basetenerror.py)**:
* [`ResponseValidationError`](https://github.com/veerbia/baseten-python/blob/master/./src/baseten/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
